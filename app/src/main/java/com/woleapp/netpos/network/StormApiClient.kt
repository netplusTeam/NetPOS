...
class StormApiClient {
    ...
    companion object {
        ...
        private var RRN_API_SERVICE_INSTANCE: RrnApiService? = null
        fun getRrnApiServiceInstance(): RrnApiService =
            RRN_API_SERVICE_INSTANCE ?: synchronized(this) {
                RRN_API_SERVICE_INSTANCE ?: Retrofit.Builder()
                    .baseUrl(RRN_BASE_URL)
                    .client(getBaseOkhttpClientBuilder().build())
                    .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                    .addConverterFactory(GsonConverterFactory.create())
                    .build().create(RrnApiService::class.java)
                    .also {
                        RRN_API_SERVICE_INSTANCE = it
                    }
            }
        ...
        private var blueCodeService: BlueCodeService? = null
...
//                        addInterceptor(BlueCodeInterceptor())
                    ...
                    .addConverterFactory(GsonConverterFactory.create())
                    .build()
                    .create(BlueCodeService::class.java)
                    .also {
                        blueCodeService = it
                    }
            }
